...
import { isRegistor as getIsRegistor, getMyDetailBuyer, getMyLotteryByPeriod } from "util/lottery";
...
const MyDetail = () => {
	...
	useEffect(() => {
		const fetchData = async () => {
			const IsRegistor = await getIsRegistor(myAddress);
			setIsRegistor(IsRegistor);
		};
	...
	useEffect(() => {
		const fetchData = async () => {
			const myDetailBuyer2 = await getMyDetailBuyer(myAddress);
			setMyDetail(myDetailBuyer2);
		};
														...
														<>
															<Accordion defaultActiveKey="0">
																...
																<Accordion.Item eventKey="1">
																	...
																	<Accordion.Body>
																		<MyLottery myListLottery={myListLottery} myPeriod={myPeriod} />
																	</Accordion.Body>
																</Accordion.Item>
															</Accordion>
														</>
